...
<body>
  ...
  <div class="col-md-4 p-4 border border-primary rounded shadow bg-light">
	...
	<form action="factout.jsp" method="post" >
 <div class="p-2 bg-warning flex-fill">
    <label for="Age:" class="form-label">Enter Number:</label>
    <input type="number" class="form-control" id="Num" placeholder="Enter Number" name="num1">
  </div>
